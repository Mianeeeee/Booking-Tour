...
public class CustomerForm extends JFrame {
    public CustomerForm(String DB_URL, String DB_USER, String DB_PASSWORD) {
        ...
        btnSubmit.addActionListener(e -> {
            ...
            // Truyền Object vào
            // new TourWindow(cus);
            new TourWindow(name, birthday, phone, email, DB_URL, DB_USER, DB_PASSWORD, customer);
        });
...
class TourWindow extends JFrame {
    ...
    public TourWindow(String name, String birthday, String phone, String email, String DB_URL, String DB_USER,
            String DB_PASSWORD, Customer customer) {
        ...
        btnPay.addActionListener(e -> {
            ...
            new XacNhanThanhToan(name, phone, n, DB_URL, DB_USER, DB_PASSWORD, customer);
        });
        panel.add(lblTour);
        panel.add(cbTour);
        panel.add(lblDate);
...
class XacNhanThanhToan extends JFrame {
    public XacNhanThanhToan(String name, String phone, int n, String DB_URL, String DB_USER, String DB_PASSWORD,
        ...
        // Gán cho total = customer.setPrice()
        customer.setPrice(BigDecimal.valueOf(total));
